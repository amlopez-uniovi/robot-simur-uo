"""
Controlador base para la demo de navegación (EPuck y RosBot)
...
def run_navigation_demo(RobotClass):
    """
    Ejecuta una demo de navegación básica para un robot dado.
    ...
    iteration = 0
    print(f"Iniciando demo de navegación para {RobotClass.__name__}...")
